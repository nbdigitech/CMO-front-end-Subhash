...
export default function AuthPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch("https://https://api.homecomputer.online//login", {
        method: "POST",
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-screen bg-gray-100">
      ...
      <div className="w-full md:w-1/3 flex flex-col items-center justify-center p-6 md:p-12">
        ...
        <p className="text-center text-black ml-[-10px] mt-6">Initiative By DPR Chhattisgarh testng subhash</p>
      </div>
